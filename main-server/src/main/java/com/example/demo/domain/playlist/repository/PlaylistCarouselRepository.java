...
public class PlaylistCarouselRepository {
    ...
    private OrderSpecifier<?>[] orderByDirectional(QPlaylist p, PlaylistSortOption sort, CarouselDirection direction) {
    ...
    private BooleanExpression cursorConditionDirectional(
        ...
        return switch (sort) {
            case RECENT -> {
                ...
                yield direction == CarouselDirection.NEXT ? p.id.lt(cursor.id()) : p.id.gt(cursor.id());
            }
            case POPULAR -> {
    ...
    public List<Playlist> findFeedCarousel(
        ...
        return queryFactory
                ...
                .where(
                        ...
                        cursorConditionDirectional(p, cursor, sort, direction)
                )
